...
/**
 * Fragment wrapper for the Karaoke Lyrics library using Jetpack Compose.
 * This provides a third lyrics display option alongside Native and Web engines.
 */
class KaraokeLyricsFragment : Fragment() {
    ...
    private fun setupComposeContent() {
        ...
        composeView?.setContent {
            KaraokeLyricsContent(lyrics = lyrics)
        }
    }
